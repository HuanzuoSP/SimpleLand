...
execute @a[scores={PlayerID=1..}] ~ ~ ~ execute @e[x=~-15,y=0,z=~-15,dx=31,dz=31,type=leash_knot,c=1,scores={LandID=1..}] ~ ~ ~ execute @a[x=~-16,y=0,z=~-16,dx=31,dy=256,dz=31] ~ ~ ~ scoreboard players operation @s CountF -= @e[x=~-15,y=0,z=~-15,dx=31,dz=31,type=leash_knot,c=1,scores={LandID=1..}] LandID
#使领地密码自动变为领地主人的领地密码
execute @a[scores={PlayerID=1..}] ~ ~ ~ execute @e[x=~-15,y=0,z=~-15,dx=31,dz=31,type=leash_knot,c=1,scores={LandID=1..}] ~ ~ ~ execute @a[x=~-16,y=0,z=~-16,dx=31,dy=256,dz=31] ~ ~ ~ scoreboard players operation @e[x=~-15,y=0,z=~-15,dx=31,dz=31,type=leash_knot,c=1,scores={LandID=1..}] LandPassword = @s[scores={CountF=0}] Password
...
execute @a[scores={PlayerID=1..}] ~ ~ ~ execute @e[x=~-15,y=0,z=~-15,dx=31,dz=31,type=leash_knot,c=1,scores={LandID=1..}] ~ ~ ~ execute @a[x=~-16,y=0,z=~-16,dx=31,dy=256,dz=31] ~ ~ ~ scoreboard players operation @s CountG -= @e[x=~-15,y=0,z=~-15,dx=31,dz=31,type=leash_knot,c=1,scores={LandID=1..}] LandPassword
#使领地内为”CountG”为<0>分的玩家,该玩家游戏模式由冒险变为生存
execute @a[scores={PlayerID=1..}] ~ ~ ~ execute @e[x=~-15,y=0,z=~-15,dx=31,dz=31,type=leash_knot,c=1,scores={LandID=1..}] ~ ~ ~ execute @a[x=~-16,y=0,z=~-16,dx=31,dy=256,dz=31] ~ ~ ~ gamemode s @s[scores={CountG=0},m=a]
#使领地内除了”CountG”为<0>分的玩家,该玩家游戏模式由生存变为冒险
execute @a[scores={PlayerID=1..}] ~ ~ ~ execute @e[x=~-15,y=0,z=~-15,dx=31,dz=31,type=leash_knot,c=1,scores={LandID=1..}] ~ ~ ~ execute @a[x=~-16,y=0,z=~-16,dx=31,dy=256,dz=31] ~ ~ ~ gamemode a @s[scores={CountG=!0},m=s]
#不在领地内的冒险模式玩家变为生存模式
execute @a[m=a] ~ ~ ~ detect ~ 0 ~ bedrock 0 gamemode s
#[圈地命令]
#初始化圈地状态
scoreboard players add @a CreateLand 0
#进入圈地状态
execute @a[scores={CreateLand=0}] ~ ~ ~ execute @e[type=item,name="圈地",r=5,scores={ItemDistinguish=1}] ~ ~ ~ scoreboard players add @a[r=5] CreateLand 1
#圈地开始
execute @a[scores={CreateLand=1}] ~ ~ ~ execute @e[type=item,name="圈地",r=5,scores={ItemDistinguish=1}] ~ ~ ~ detect ~ ~-1 ~ emerald_block 0 scoreboard players add @s LandInfo 0
#判断领地是否重叠
execute @a[scores={CreateLand=1}] ~ ~ ~ execute @e[type=item,name="圈地",r=5,scores={ItemDistinguish=1,LandInfo=0}] ~ ~ ~ execute @e[x=~-31,y=0,z=~-31,dx=62,dz=62,type=leash_knot,c=1,scores={LandID=1..}] ~ ~ ~ scoreboard players add @e[type=item,name="圈地",scores={ItemDistinguish=1,LandInfo=0}] LandInfo 1
execute @a[scores={CreateLand=1}] ~ ~ ~ execute @e[type=item,name="圈地",r=5,scores={ItemDistinguish=1,LandInfo=1}] ~ ~ ~ title @p subtitle 这里和另一块领地存在重叠
execute @a[scores={CreateLand=1}] ~ ~ ~ execute @e[type=item,name="圈地",r=5,scores={ItemDistinguish=1,LandInfo=1}] ~ ~ ~ title @p title §4圈地失败！
#标记圈地失败的物品
execute @a[scores={CreateLand=1}] ~ ~ ~ execute @e[type=item,name="圈地",r=5,scores={ItemDistinguish=1,LandInfo=1}] ~ ~ ~ scoreboard players add @e[type=item,name="圈地",scores={ItemDistinguish=1,LandInfo=1}] ItemDistinguish 1
#圈地失败退出圈地状态
execute @a[scores={CreateLand=1}] ~ ~ ~ execute @e[type=item,name="圈地",r=5,scores={ItemDistinguish=2,LandInfo=1}] ~ ~ ~ scoreboard players remove @a[r=5] CreateLand 1
#圈地没有重叠
execute @a[scores={CreateLand=1}] ~ ~ ~ execute @e[type=item,name="圈地",r=5,scores={ItemDistinguish=1,LandInfo=0}] ~ ~ ~ fill ~-20 0 ~-20 ~20 0 ~20 bedrock 1
execute @a[scores={CreateLand=1}] ~ ~ ~ execute @e[type=item,name="圈地",r=5,scores={ItemDistinguish=1,LandInfo=0}] ~ ~ ~ fill ~-15 0 ~-15 ~15 0 ~15 barrier 0
execute @a[scores={CreateLand=1}] ~ ~ ~ execute @e[type=item,name="圈地",r=5,scores={ItemDistinguish=1,LandInfo=0}] ~ ~ ~ fill ~ 1 ~ ~ 1 ~ barrier 0
execute @a[scores={CreateLand=1}] ~ ~ ~ execute @e[type=item,name="圈地",r=5,scores={ItemDistinguish=1,LandInfo=0}] ~ ~ ~ fill ~ 0 ~ ~ 0 ~ nether_brick_fence 0 destroy
execute @a[scores={CreateLand=1}] ~ ~ ~ execute @e[type=item,name="圈地",r=5,scores={ItemDistinguish=1,LandInfo=0}] ~ ~ ~ summon leash_knot ~ 0 ~
execute @a[scores={CreateLand=1}] ~ ~ ~ execute @e[type=item,name="圈地",r=5,scores={ItemDistinguish=1,LandInfo=0}] ~ ~ ~ scoreboard players operation @e[y=0,r=1,type=leash_knot,c=1] LandID = @p[scores={CreateLand=1}] PlayerID
execute @a[scores={CreateLand=1}] ~ ~ ~ execute @e[type=item,name="圈地",r=5,scores={ItemDistinguish=1,LandInfo=0}] ~ ~ ~ scoreboard players operation @e[y=0,r=1,type=leash_knot,c=1] LandPassword = @p[scores={CreateLand=1}] Password
execute @a[scores={CreateLand=1}] ~ ~ ~ execute @e[type=item,name="圈地",r=5,scores={ItemDistinguish=1,LandInfo=0}] ~ ~ ~ title @p title §6圈地成功！
execute @a[scores={CreateLand=1}] ~ ~ ~ execute @e[type=item,name="圈地",r=5,scores={ItemDistinguish=1,LandInfo=0}] ~ ~ ~ fill ~ ~-1 ~ ~ ~-1 ~ air
#标记圈地成功的物品
execute @a[scores={CreateLand=1}] ~ ~ ~ execute @e[type=item,name="圈地",r=5,scores={ItemDistinguish=1,LandInfo=0}] ~ ~ ~ scoreboard players add @e[type=item,name="圈地",r=5,scores={ItemDistinguish=1,LandInfo=0}] ItemDistinguish 1
#退出圈地状态
execute @a[scores={CreateLand=1}] ~ ~ ~ execute @e[type=item,name="圈地",r=5,scores={ItemDistinguish=2,LandInfo=0}] ~ ~ ~ scoreboard players remove @a[r=5,scores={CreateLand=1}] CreateLand 1
#领地拆除
#[运行]
