...
execute @a[scores={PlayerID=1..}] ~ ~ ~ execute @e[x=~-15,y=0,z=~-15,dx=31,dz=31,type=leash_knot,c=1,scores={LandID=1..}] ~ ~ ~ execute @a[x=~-16,y=0,z=~-16,dx=31,dy=256,dz=31] ~ ~ ~ scoreboard players operation @s CountF -= @s LandID
#使领地密码自动变为领地主人的领地密码
...
execute @a[scores={PlayerID=1..}] ~ ~ ~ execute @e[x=~-15,y=0,z=~-15,dx=31,dz=31,type=leash_knot,c=1,scores={LandID=1..}] ~ ~ ~ execute @a[x=~-16,y=0,z=~-16,dx=31,dy=256,dz=31] ~ ~ ~ scoreboard players operation @s CountG -= @s LandPassword
